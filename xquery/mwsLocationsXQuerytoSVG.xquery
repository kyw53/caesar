...
<html>
    ...
    <body> 
        ...
        return
        <svg xmlns="http://www.w3.org/2000/svg" width="600" height="{($bookCount * $sectionHeight) + 50}">
        {
            ...
            let $top5 :=
                for $placename in distinct-values($book//Q{}place/string())
                let $count := count($book//Q{}place[string() = $placename])
