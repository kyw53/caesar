...
<html>
    ...
    <body>
        ...
        <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewbox="0 0 2400 1000">
    <g transform="translate(425,50)">
    <g>
    <text x="0" y="-5" font-family="sans-serif" font-size="20px" fill="black">In which book is Caesar mentioned the most the most times?</text>
    </g>
    <g>
        {
            ...
            return
                ...
                <text x="-75" y="{$pos * $yspacer + 5}" font-family="sans-serif" font-size="12px" fill="black">{$pos}</text>
                <line x1="0" y1="{$pos * $yspacer}" x2="{$caesar-count * $xspacer}" y2="{$pos * $yspacer}" stroke="#6B1F1F" fill="none" stroke-width="15"/>
                <text x="{$caesar-count * $xspacer + 10}" y="{$pos * $yspacer + 5}" font-family="sans-serif" font-size="12px" fill="black">{$caesar-count}</text>
                <line x1="0" y1="0" x2="0" y2="{$caesar-count* $yspacer}" stroke="black" stroke-width="2"/>
                </g>
        }
        </g>
    </g>
